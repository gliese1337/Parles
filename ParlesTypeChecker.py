from ParlesAST import Literal, Word, Seq, Pipe, Method, Scope, Paren, Block, Quote
from ParlesTypes import FuncType, StackType, genvar, reset
...
def blocktype(node, tenv):
  ...
  argtypes = list(reversed(a.type for a in node.args))
